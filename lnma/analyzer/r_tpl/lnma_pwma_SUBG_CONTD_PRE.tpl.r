## Subgroup Analysis of precalculated data (continuous: mean/se)
# Load meta package.
library (meta)
...
# library(readxl)
# SUBGROUP_CONTD_PREDATA <- read_excel("C:/Users/sarsa/Desktop/Vitals/Research Stuff/MA/Studies/Living System/Code data_script/Data/SUBGROUP_CONTD_PREDATA.xlsx")
SUBGROUP_CONTD_PREDATA <- read.csv("{{ fn_csvfile }}")
