## PWMA: Primary Meta-Analysis of precalculated (computed) data (continuous: mean/se)
# Load meta package.
library (meta)
...
# library(readxl)
# PRI_CONTD_PREDATA <- read_excel("C:/Users/sarsa/Desktop/Vitals/Research Stuff/MA/Studies/Living System/Code data_script/Data/PRI_CONTD_PREDATA.xlsx")

PRI_CONTD_PREDATA <- read.csv("{{ fn_csvfile }}")
